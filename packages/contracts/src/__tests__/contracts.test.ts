...
describe("contracts", () => {
  ...
  it("accepts latest round result proof shape", () => {
    const result = LatestRoundResultSchema.safeParse({
      ...
      fairness: {
        algorithm: "HMAC_SHA256_REJECTION_SAMPLING_V1",
        ...
        entriesHash: "entries-hash",
        recomputedEntriesHash: "entries-hash",
        entriesHashMatches: true,
        totalEntryAmount: "1000",
        winningTicket: "557",
        drawInput: "canonical-draw-input",
        drawHash: "draw-hash",
        recomputedDrawHash: "draw-hash",
