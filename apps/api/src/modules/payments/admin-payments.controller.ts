...
import { AdminAuditAction, DepositStatus, Role, WithdrawalStatus } from "@kingspin/db";
...
export class AdminPaymentsController {
  ...
  listDeposits(@Query("status") status?: DepositStatus, @Query("userId") userId?: string) {
  ...
  async approveWithdrawal(
    ...
    const result = await this.withdrawalsService.approveWithdrawal(id, admin.id);
