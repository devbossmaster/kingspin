...
import { OfficialTelebirrProvider } from './providers/official-telebirr/official-telebirr.provider';
import { TelebirrReceiptClient } from './providers/telebirr-receipt/telebirr-receipt.client';
import { TelebirrReceiptParser } from './providers/telebirr-receipt/telebirr-receipt.parser';
...
@Module({
  ...
  providers: [
    ...
    MockPaymentProvider,
    TelebirrReceiptClient,
    TelebirrReceiptParser,
    TelebirrReceiptProvider,
    OfficialTelebirrProvider,
  ],
